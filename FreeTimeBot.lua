...
function setAdvancedOptions()
  ...
  starAccuracy = starDetectPct * 0.01
...
function liveArenaSelectMon(choice)
  liveArenaChoiceMonRegion:existsClick(Pattern("chasun.png"):similar(0.6), 0.1)
  liveArenaTopRegion:existsClick(Pattern("liveArenaOk.png"):similar(runeAccuracy), 0.1)
  liveArenaChoiceMonRegion:existsClick(Pattern("moLongChoice.png"):similar(0.6), 0.1)
  liveArenaTopRegion:existsClick(Pattern("liveArenaOk.png"):similar(runeAccuracy), 0.1)
  liveArenaChoiceMonRegion:existsClick(Pattern("ritesh.png"):similar(0.6), 0.1)
  liveArenaTopRegion:existsClick(Pattern("liveArenaOk.png"):similar(runeAccuracy), 0.1)
  liveArenaChoiceMonRegion:existsClick(Pattern("chloe.png"):similar(0.6), 0.1)
  liveArenaTopRegion:existsClick(Pattern("liveArenaOk.png"):similar(runeAccuracy), 0.1)
  liveArenaChoiceMonRegion:existsClick(Pattern("camilla.png"):similar(0.6), 0.1)
  liveArenaTopRegion:existsClick(Pattern("liveArenaOk.png"):similar(runeAccuracy), 0.1)
end
