...
stoneRarityImages = {"grindLegend.png", "grindHero.png", "grindRare.png"}
...
stoneRarityRegion = Region(580, 294, 758, 246)
...
function dialogBox()
  ...
  dialogShowFullScreen("PalBot Config:")
end
...
function sellGetGemStone ()
  stoneRarityRegion:highlight()
  local bestMatchIndex = existsMultiMax(stoneRarityImages, stoneRarityRegion)
  if stoneRarityRegion:exists(Pattern("grindLegend.png"):similar(imgAccuracy), 0.1) then
    raidGetRegion:existsClick(Pattern("get.png"):similar(0.6), 0.1)
	toast("Get!")
  elseif stoneRarityRegion:exists(Pattern("grindHero.png"):similar(imgAccuracy), 0.1) then
    raidGetRegion:existsClick(Pattern("get.png"):similar(0.6), 0.1)
	toast("Get!")
  elseif stoneRarityRegion:exists(Pattern("grindRare.png"):similar(imgAccuracy), 0.1) then
    raidSellStoneRegion:existsClick(Pattern("sellStone.png"):similar(0.6), 0.1)
	toast("Sell!")
  elseif sellAllRune == true then
    existsClick(Pattern("sellStone.png"):similar(0.6), 0.1)
  elseif keepAll == true then
    existsClick(Pattern("get.png"):similar(0.6), 0.1)
  end
  stoneRarityRegion:highlight()
end   
