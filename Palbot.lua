...
function sellGetGemStone ()
  if exists(Pattern("grindLegend.png"):similar(.7), 0.1) then	
    existsClick(Pattern("get.png"):similar(0.6), 0.1)
	toast("Get!")
  elseif exists(Pattern("grindHero.png"):similar(.7), 0.1) then
    existsClick(Pattern("get.png"):similar(0.6), 0.1) 
	toast("Get!")
  elseif exists(Pattern("grindLegend.png"):similar(.7), 0.1) then
    existsClick(Pattern("get.png"):similar(0.6), 0.1)
  elseif exists(Pattern("grindRare.png"):similar(.7), 0.1) then	
